...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("deleteClientClose")
    ?.addEventListener("click", closeDeleteClientModal);
  document
    .getElementById("deleteClientCancel")
    ?.addEventListener("click", closeDeleteClientModal);
  ...
  document
    .getElementById("indexImageModalClose")
  ...
  const dashboardCards = document.querySelectorAll(
    ".dashboards-section .dashboard-card",
  );
  ...
  document
    .querySelector(".dashboards-section")
    ?.addEventListener("click", function (e) {
  ...
  function filterContent() {
    ...
    clientCards.forEach((card) => {
      ...
      const matchesSearch =
        ...
        clientDescription.includes(searchTerm);
    ...
    dashboardCards.forEach((card) => {
      ...
      const dashboardClient = card
        .querySelector(".dashboard-client")
        .textContent.toLowerCase();
    ...
    if (
      ...
      if (dashboardsSection) {
        dashboardsSection.style.display =
          visibleDashboardsCount > 0 ? "block" : "none";
      }
    }
  ...
  favoriteClientBtns.forEach((btn) => {
    btn.addEventListener("click", async function (e) {
      ...
      try {
        ...
        if (data.success) {
          // Como a posição do cliente deve mudar (ir para a área de favoritos ou sair dela),
          // a melhor UX aqui é recarregar a página levemente para que as listas se reorganizem,
          // ao invés de apenas pintar a estrela.
