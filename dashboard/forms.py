...
class DashboardForm(forms.ModelForm):
    class Meta:
        model = Dashboard
        fields = ['title', 'description', 'faq','image', 'json', 'categories']
        ...
        widgets = {
            ...
            'faq': forms.Select(attrs={'class': 'form-input'}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['faq'].label = "FAQ Relacionada"
        self.fields['faq'].empty_label = "Selecione a documentação (FAQ)..."
